...
class Category extends \Entities\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Category' . "\0" . 'id', '' . "\0" . 'Entities\\Category' . "\0" . 'displayname', '' . "\0" . 'Entities\\Category' . "\0" . 'shortdesc', '' . "\0" . 'Entities\\Category' . "\0" . 'longdesc', '' . "\0" . 'Entities\\Category' . "\0" . 'createdon', '' . "\0" . 'Entities\\Category' . "\0" . 'status', '' . "\0" . 'Entities\\Category' . "\0" . 'psudosubscriptioncount');
        }
    ...
    public function setPsudosubscriptioncount($psudosubscriptioncount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPsudosubscriptioncount', array($psudosubscriptioncount));

        return parent::setPsudosubscriptioncount($psudosubscriptioncount);
    }
    ...
    public function getPsudosubscriptioncount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPsudosubscriptioncount', array());

        return parent::getPsudosubscriptioncount();
    }
