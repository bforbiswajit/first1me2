...
class Deals extends \Entities\Deals implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Deals' . "\0" . 'id', '' . "\0" . 'Entities\\Deals' . "\0" . 'createdon', '' . "\0" . 'Entities\\Deals' . "\0" . 'thumbnailimg', '' . "\0" . 'Entities\\Deals' . "\0" . 'bigimg', '' . "\0" . 'Entities\\Deals' . "\0" . 'region', '' . "\0" . 'Entities\\Deals' . "\0" . 'shortdesc', '' . "\0" . 'Entities\\Deals' . "\0" . 'longdesc', '' . "\0" . 'Entities\\Deals' . "\0" . 'likes', '' . "\0" . 'Entities\\Deals' . "\0" . 'views', '' . "\0" . 'Entities\\Deals' . "\0" . 'psudoviews', '' . "\0" . 'Entities\\Deals' . "\0" . 'expireson', '' . "\0" . 'Entities\\Deals' . "\0" . 'status', '' . "\0" . 'Entities\\Deals' . "\0" . 'categoryid', '' . "\0" . 'Entities\\Deals' . "\0" . 'vendorid');
        }
    ...
    public function setPsudoviews($psudoviews)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPsudoviews', array($psudoviews));

        return parent::setPsudoviews($psudoviews);
    }
    ...
    public function getPsudoviews()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPsudoviews', array());

        return parent::getPsudoviews();
    }
